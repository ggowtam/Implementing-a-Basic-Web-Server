...
def main():
    ...
    context.load_cert_chain('server-public-key.pem', "server-private-key.pem", password="serverpassword")
...
def http_handle(request_string):
    ...
    if req_dic['METHOD'] not in http_methods or 'http' not in req_dic['VERSION']:
